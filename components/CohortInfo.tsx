...
export default function CohortInfo() {
  const timeline = [
    {
      title: "Registrations",
      date: BUILDER_SPRINT.registrationWindowLabel,
      description:
        "Submit your registration before the deadline or while seats remain.",
    },
    {
      title: "Onboarding",
      date: BUILDER_SPRINT.onboardingPeriodLabel,
      description:
        "Meet the community, set your goals, and prepare to build.",
    },
    {
      title: "Builder Sprint",
      date: BUILDER_SPRINT.sprintPeriodLabel,
      description:
        "Build consistently for 14 days with accountability.",
    },
    {
      title: "Demo Day",
      date: "After Sprint",
      description:
        "Showcase your project and become part of the Builder Network.",
    },
  ];
